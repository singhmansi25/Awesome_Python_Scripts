...
# The Algorithm
# Number of chocolates you will get with your money and price of chocolates
chocolates = money//price

# Number of wrappers when you will buy chocolates
number_of_wrappers = money//price
